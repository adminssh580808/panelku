							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form mt-2">
										...
										<div class="form-group">
											<button "submit" class="btn btn-primary float-right">{{__('Ubah')}} </button>
										</div>
									</div>
								</div>
							</div>
          		...
          		<div class="col-md-5">
          			...
          			<div class="card">
          				<form method="POST">
          					@csrf
	          				<div class="card-body">
          					<h4 class='header-title mt-0'>{{__('Merubah Password')}} </h4>
	          					<div class="form-group">
		          					<label>{{__('Kata Sandi Sekarang')}}</label>
	          					...
	          					<div class="form-group">
		          					<label>{{__('Ulangi Kata Sandi Baru')}}</label>
