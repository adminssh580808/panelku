        ...
        <div class="page-title-box">
          ...
          <div class="section-body">
          	...
          	<div class="row">
                  ...
                  <div class="card-body">
		                <h4 class='header-title mt-0 mb-1'><span>Kelola Pesanan Pulsa</span></h4>
                          ...
                          <div class="table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td style="display: inline-block;">
                                        <a href="{{ url('developer/orders/pulsa/edit/'.$order->id)}}" class="btn btn-primary"><i data-feather="edit"></i></a>
