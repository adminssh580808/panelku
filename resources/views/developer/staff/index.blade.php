        ...
        <div class="page-title-box">
          ...
          <div class="section-body">
          	...
          	<div class="row">
                  ...
                  <div class="card-body">
		                <h4 class='header-title mt-0 mb-1'><span><i class=" dripicons-user-group "></i> Semua Staff</span></h4>
                     @if(session('success'))
                      ...
                      <table class="table table-striped table-md">
                          ...
                          <tr>
                            ...
                            <td style="display: inline-flex">
                              <a href="{{ url('developer/staff/edit/'.$data->id) }}" class="btn btn-info mr-1">Edit</a>
