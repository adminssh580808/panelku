        		...
        		<div class="col-md-12">
	                ...
	                <div class="">
                      ...
                      <form method="POST" action="">
                          @csrf
                        <div class="card-body">
                          <h4 class='header-title mt-0 mb-1'><span>Tambah Layanan Pulsa</span></h4>
                          @if ($errors->any())
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <input type="number" name="keuntungan" class="form-control" placeholder="Keuntungan ">
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <label>Code / Provider ID</label>
                              <input type="text" name="code" class="form-control" placeholder="Masukkan kode/id layanan dari provide (Kosongkan jika provider MANUAL)" class="form-control">
                            </div>
                            <div class="form-group">
