          	...
          	<div class="row">
          		<div class="col-md-12">
          			<div class="card">
                        ...
                        @csrf
                          <div class="card-body">
		                        <h4 class='header-title mt-0'><span>Tambah Top Giveaway</span></h4>
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Masukan Code Voucher" class="form-control" name="code1">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Masukan Code Voucher" class="form-control" name="code2">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Masukan Code Voucher" class="form-control" name="code3">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Masukan Code Voucher" class="form-control" name="code4">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Masukan Code Voucher" class="form-control" name="code5">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
