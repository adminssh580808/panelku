...
<html lang="en">
    <head>
        ...
        <meta content="{{ config('web_config')['APP_NAME'] }} | SMM Panel Termurah dan berkualitas tinggi yang menjual jasa layanan Instagram followers,like,view sampai Layanan Youtube seperti subscriber, views, likes. Bergabunglah bersama kami dan tingkatkan penghasilan anda" name="description" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
                    ...
                    <div class="container-fluid">
                        ...
                        <div id="navigation">
                            ...
                            <ul class="navigation-menu">
                                ...
                                <li class="has-submenu">
                                    <a href="{{ url('/developer') }}"><i class="dripicons-graph-bar"></i> Statistic</a>
                                </li>
                                <li class="has-submenu">
                                    <a href="{{ url('/developer/users') }}"><i class="dripicons-user"></i> Kelola Pengguna</a>
                                </li>
                                <li class="has-submenu">
                                    <a href="#"><i class="dripicons-cart"></i> Sosial Media <i class="mdi mdi-chevron-down mdi-drop"></i></a>
                                    <ul class="submenu">
                                ...
                                <li class="has-submenu">
                                    <a href="#"><i class="dripicons-cart"></i> Pulsa & PPOB <i class="mdi mdi-chevron-down mdi-drop"></i></a>
                                    <ul class="submenu">
                                ...
                                <li>
                                    <a href="{{ url('developer/providers') }}" >
                                ...
                                <li class="has-submenu">
                                    ...
                                    <ul class="submenu ">
                                        <li>
                                            <ul>
                                                <li>
                                                    <a href="{{ url('developer/configuration') }}" >
                                                        <span> Konfigurasi Website</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ url('developer/news') }}" >
                                                        <span> Kelola Berita</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ url('developer/staff') }}" >
                                                        <span> Kelola Staff</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ url('developer/ticket') }}">
                                                        <span> Kelola Tiket</span>
                                                        @if(config('unread_ticket_dev') != 0)
                                                            <span class="badge badge-primary">{{ config('unread_ticket_dev') }}</span>
                                                        @endif
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ url('developer/activity') }}" >
                                                        <span> Log Aktifitas</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ url('developer/custom_price') }}">
