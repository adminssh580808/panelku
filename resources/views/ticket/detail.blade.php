    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title m-0">{{ __('Judul') }} : {{ $data_ticket->subject }}</h4>
                </div>
                <!-- end col -->
            </div>
            <hr>
          ...
          <div class="section-body">
          	...
          	<div class="row">
                  ...
                  <div class="card-body">
		                <h4 class='header-title mt-0 mb-2'><span>{{ __('Tiket Saya') }}</span></h4>
		              	@if(session('success'))
                    ...
                    @if($data_ticket->status != 'Closed')
                     ...
                     @else
                      <p>Ticket ditutup, silahkan buat <a href="{{ url('/ticket/add') }}">{{ __('tiket baru') }}</a></p>
                     @endif
		              </div>
