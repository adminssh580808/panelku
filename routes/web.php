...
Route::get('/soon','HomeController@soonPage');
Route::get('/terms','HomeController@terms');
Route::get('/request','HomeController@requestService');
...
Route::get('/service-landing','ServiceLandingController@index');
...
Route::group(['middleware'=>['auth','localize']], function() {
	...
	Route::prefix('/deposit')->group(function() {
        ...
        Route::get('/invoice/{id}','DepositController@invoice')->name('deposit_invoice');
...
Route::group(['prefix'=>'developer', 'middleware'=>['auth','Developer'] ],function() {
    ...
    Route::prefix('/top-user')->group(function(){
        Route::get('/', 'Admin\TopUserController@index');
        Route::get('/order', 'Admin\TopUserController@top_order');
        Route::post('/order', 'Admin\TopUserController@add_toporder')->name('add_top_order');
        Route::get('/order/edit/{id}', 'Admin\TopUserController@edit_top_order')->name('top_order_edit');
        Route::post('/order/edit/{id}', 'Admin\TopUserController@update_top_order')->name('top_order_update');
        Route::get('/deposit', 'Admin\TopUserController@top_deposit');
        Route::post('/deposit', 'Admin\TopUserController@add_topdeposit')->name('add_top_deposit');
        Route::get('/deposit/edit/{id}', 'Admin\TopUserController@edit_top_deposit')->name('top_deposit_edit');
        Route::post('/deposit/edit/{id}', 'Admin\TopUserController@update_top_deposit')->name('top_deposit_update');
        Route::get('/giveaway', 'Admin\TopUserController@top_giveaway');
        Route::post('/giveaway', 'Admin\TopUserController@add_topgiveaway')->name('add_top_giveaway');
        Route::get('/giveaway/edit/{id}', 'Admin\TopUserController@edit_top_giveaway')->name('top_giveaway_edit');
        Route::post('/giveaway/edit/{id}', 'Admin\TopUserController@update_top_giveaway')->name('top_giveaway_update');
	});
    ...
    Route::prefix('/bahasa')->group(function(){
		Route::get('/', 'PageBahasaController@index');
        Route::get('/add', 'PageBahasaController@create');
        Route::post('/add', 'PageBahasaController@store');
	});
...
// Route::get('/home', 'OrderController@sosmed')->name('home');
